                ...
                },
                {
                  ...
                  description: (
                    <Description isActive={current >= 1}>
                      ...
                      counterparty and select Fiat/Crypto currency. An email
                      will be sent to notify your counterparty.
                    </Description>
                  ),
                },
                {
                ...
                },
                {
                  ...
                  description: (
                    <Description isActive={current >= 3}>
                      ...
                      transaction will go into a dispute. ESCROW SG will then
                      step in as the neutral third-party to resolve the dispute.
                    </Description>
                  ),
                },
              ]}
